...
class TestSetupPy:
    ...
    def test_setup_py_has_required_dependencies(self):
        ...
        assert 'install_requires=' in content, \
            "setup.py should have install_requires section"
...
class TestRagstackCommonStructure:
    ...
    def test_ragstack_common_has_init(self):
        ...
        assert init_file.exists(), \
            "lib/ragstack_common/__init__.py should exist for Python package"
    ...
    def test_ragstack_common_has_required_modules(self):
        ...
        for module in required_modules:
            ...
            assert module_path.exists(), \
                f"Required module {module} should exist in ragstack_common"
...
class TestLambdaRequirements:
    ...
    def test_process_document_requirements_reference_lib(self):
        ...
        assert req_file.exists(), \
            "process_document should have requirements.txt"

        content = req_file.read_text()
        assert './lib' in content, \
            "process_document requirements should reference ./lib package"
    ...
    def test_generate_embeddings_requirements_reference_lib(self):
        ...
        assert req_file.exists(), \
            "generate_embeddings should have requirements.txt"

        content = req_file.read_text()
        assert './lib' in content, \
            "generate_embeddings requirements should reference ./lib package"
    ...
    def test_lambda_functions_import_ragstack_common(self):
        ...
        for func_name in functions_with_lib:
            ...
            assert index_path.exists(), \
                f"{func_name}/index.py should exist"
...
class TestPackageInstallation:
    ...
    def test_no_symlinks_in_lambda_directories(self):
        ...
        assert not shared_dir.exists(), \
            "src/lambda/shared symlink directory should be removed"
    ...
    def test_gitignore_excludes_build_artifacts(self):
        ...
        assert '.aws-sam/' in content, \
            ".gitignore should exclude .aws-sam/ directory"
        assert 'layers/' in content, \
            ".gitignore should exclude layers/ directory"
