...
class TestScrapeDiscoverHandler:
    ...
    def test_sqs_message_parsing(self, mock_aws, mock_fetcher):
    ...
    def test_duplicate_url_handling(self, mock_aws, mock_fetcher):
    ...
    def test_job_cancelled_skips_processing(self, mock_aws, mock_fetcher):
    ...
    def test_job_not_found(self, mock_aws, mock_fetcher):
...
class TestJobCounterUpdates:
    ...
    def test_increments_total_urls(self, mock_aws, mock_fetcher):
...
class TestUrlDiscovery:
    ...
    def test_discovers_links_from_content(self, mock_aws, mock_fetcher):
