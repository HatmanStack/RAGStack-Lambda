...
def test_lambda_handler_success(mock_document_class, mock_ocr_service_class, mock_update_item,
                                  valid_event, lambda_context, mock_document):
...
@patch('index.OcrService')
@patch('index.Document')
def test_lambda_handler_ocr_failure(mock_document_class, mock_ocr_service_class,
                                     mock_update_item, valid_event, lambda_context):
...
@patch('index.OcrService')
@patch('index.Document')
def test_lambda_handler_with_bedrock_backend(mock_document_class, mock_ocr_service_class,
                                               mock_update_item, lambda_context, mock_document):
...
@patch('index.OcrService')
@patch('index.Document')
def test_lambda_handler_page_text_truncation(mock_document_class, mock_ocr_service_class,
                                               mock_update_item, valid_event, lambda_context):
