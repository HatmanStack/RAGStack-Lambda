...
1. [Subscribe to RAGStack on AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-5afdiw2zrht6o) (free, not required — Lambda roles auto-accept Bedrock model agreements on first invocation)
