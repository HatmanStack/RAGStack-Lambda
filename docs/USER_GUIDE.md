...
The Settings page allows you to modify runtime configuration without redeploying the stack. You can adjust OCR backends and chat models to optimize for cost, speed, or quality.
...
The Settings page shows **3 configurable parameters**. Embedding models are hardcoded and not shown in Settings.
...
**When to change**: Switch to Bedrock for documents with complex layouts, poor scan quality, or multilingual content.

**Impact**: Changes take effect immediately for newly uploaded documents. No re-processing of existing documents needed.
...
- **claude-3-5-haiku** (default): Fastest and most cost-effective
- **claude-3-5-sonnet**: Balanced speed and accuracy
- **claude-3-opus**: Most accurate, best for complex documents

**When to change**: Use Sonnet or Opus for higher accuracy on challenging documents with complex tables, handwriting, or degraded quality.
...
- **claude-3-5-haiku** (default): Fastest responses, cost-effective
- **claude-3-5-sonnet**: Balanced speed and quality
- **claude-3-opus**: Most detailed responses

**When to change**: Use Sonnet or Opus when you need more detailed, nuanced answers from the Knowledge Base.

**Impact**: Changes take effect immediately on the next query. No document re-processing needed.

### Embedding Models

**Note**: Embedding models are **not configurable** through the Settings UI. They are hardcoded to:

- **Text embeddings**: `amazon.titan-embed-text-v2:0`
- **Image embeddings**: `amazon.titan-embed-image-v1`

These models provide excellent performance for most use cases. If you need different embedding models, see the [Configuration Guide](CONFIGURATION.md#changing-embedding-models-advanced) for details on modifying them in code.
...
4. Changes take effect **immediately** on the next document upload or query

**Important**: All configuration changes take effect immediately—**no document re-processing required**.
...
- **Chat Model**: Use Haiku for general queries, Sonnet/Opus for complex questions

#### For Production Workloads

- **OCR Backend**: Start with Textract, switch to Bedrock only when needed
- **Chat Model**: Use Sonnet for good balance of quality and cost
- **Monitoring**: Track costs in AWS Cost Explorer to optimize settings

#### For Multilingual Content

- **OCR Backend**: Use Bedrock with Sonnet or Opus models
- **Bedrock OCR Model**: Sonnet handles multiple languages well
- **Chat Model**: Sonnet or Opus for multilingual query responses

#### For Complex Documents

- **OCR Backend**: Switch to Bedrock for tables, handwriting, or degraded quality
- **Bedrock OCR Model**: Use Sonnet or Opus for highest accuracy
- **Chat Model**: Use Sonnet or Opus for detailed answers
