...
- [ ] P0.1: Create `lib/ragstack_common/ingestion.py`
- [ ] P0.2: Add `generate_presigned_url()` to storage.py
- [ ] P0.3: Add `write_metadata_to_s3()` to storage.py
- [ ] P0.4: Enforce `parse_s3_uri()` usage (remove 4 duplicates)
